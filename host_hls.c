...
int write_output(int fd, char ** bounds, int32_t *integrals, struct SW_Data_Packet * data_packet) {
...
int produce_output(char ** bounds, int32_t *integrals, struct SW_Data_Packet * data_packet) {
